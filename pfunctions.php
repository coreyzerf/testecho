...
function addPayment($data) {
	...
	if (is_array($data)) {
		$stmt = "INSERT INTO `payments` (txnid, payment_amount, payment_status, itemid, createdtime) VALUES (" . $data['txn_id'] . ", " . $data['payment_amount'] . ", " . $data['payment_status'] . ", " . $data['item_number'] . ", " . date('Y-m-d H:i:s') . ")";
